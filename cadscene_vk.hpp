...
#if SW_MESHLET
    VkDeviceSize meshIndexOffsetOffset;
    VkDeviceSize indirectCommandOffset;
#endif
  };
...
#if SW_MESHLET
    VkDescriptorBufferInfo meshIndexOffsetInfo{};
...
#if SW_MESHLET
  VkDeviceSize m_maxMeshIndexOffsetChunk;
  VkDeviceSize m_maxIndirectCommandChunk;
#endif
